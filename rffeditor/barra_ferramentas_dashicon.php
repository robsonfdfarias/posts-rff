...
<!-- <span class="img"></span>
<span id="icones" class="dashicons dashicons-media-text img"></span> -->
    ...
    <button class="img dashicons dashicons-editor-bold" title="Colocar em Negrito" onClick="negrito(), this.setAttribute('style', 'background-color:#cdcdcd;'), selectElem()" id="negrito"></button>
    <button class="img dashicons dashicons-editor-italic" title="Colocar em Itálico" onClick="italico(), this.setAttribute('style', 'background-color:#cdcdcd;'), selectElem()" id="italico"></button>
    <button class="img dashicons dashicons-editor-underline" title="Colocar em Sublinhado" onClick="sublinhado(), this.setAttribute('style', 'background-color:#cdcdcd;'), selectElem()" id="sublinhado"></button>
    <button class="img dashicons dashicons-editor-strikethrough" title="Adicionar linha riscada" onClick="addStrikeThrough(), this.setAttribute('style', 'background-color:#cdcdcd;'), selectElem()" id="strike"></button>
    <button class="img dashicons dashicons-editor-alignright" title="Colocar em Negrito" onClick="negrito(), this.setAttribute('style', 'background-color:#cdcdcd;'), selectElem()" id="negrito"></button>
    <button class="img dashicons dashicons-editor-aligncenter" title="Colocar em Negrito" onClick="negrito(), this.setAttribute('style', 'background-color:#cdcdcd;'), selectElem()" id="negrito"></button>
    <button class="img dashicons dashicons-editor-alignleft" title="Colocar em Negrito" onClick="negrito(), this.setAttribute('style', 'background-color:#cdcdcd;'), selectElem()" id="negrito"></button>
    <!-- <button class="img dashicons dashicons-editor-bold" title="Colocar em Negrito" onClick="negrito(), this.setAttribute('style', 'background-color:#cdcdcd;'), selectElem()" id="negrito"></button> -->
    ...
    <img src="<?php echo POSTS_RFF_URL_EDITOR; ?>imgEditor/insertShadowText.svg" title="Inserir sombra no texto (alt+s)" onClick="insertTag('rffTextShadow')" id="rffTextShadow" />
    <img src="<?php echo POSTS_RFF_URL_EDITOR; ?>imgEditor/insertNeonText.svg" title="Inserir um neon no texto (alt+n)" onClick="insertTag('rffNeonText')" id="rffNeonText" />
    <img src="<?php echo POSTS_RFF_URL_EDITOR; ?>imgEditor/insertNeonTextEColorWhite.svg" title="Inserir um neon no texto e deixar o texto transparente (alt+t)" onClick="insertTag('rffNeonTextEColorWhite')" id="rffNeonTextEColorWhite" />
    ...
    <select name="formatH" id="formatH" style="<?php echo $styleSelect; ?>">
        ...
        <option value="padrao" disabled selected name="padrao" id="padrao">Parágrafo</option>
    </select>
